...
Highlights include:
- Implementing ray-based rendering logic for realistic image formation
- Computing pixel color from ray-scene interactions
- Extending beyond rasterization-focused workflows into physically motivated rendering ideas

---

### 5) Focused Graphics Module  
**Folder:** `Agrawal_220791_Assignment5`  
**Key files:** `main.html`, `main.js`

A compact project emphasizing targeted implementation:
- Streamlined graphics execution in JavaScript/WebGL
- Focus on specific visual/interactive behavior
- Consolidation of patterns developed across earlier projects

## Skills Demonstrated

- WebGL graphics pipeline setup
- 2D/3D transformations and matrix math
- Texture mapping and asset integration
- **Ray tracing implementation**
- JavaScript-based rendering architecture and debugging
- Incremental graphics feature development

## Folder Structure

```text
CS360/
├── Agrawal_220791_Assignment1/
